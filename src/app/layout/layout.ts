...
export class LayoutComponent {
    ...
    navigateToDefaultPrices() {
        this.router.navigate(['/default-prices']);
    }

    navigateToTimePeriods() {
        this.router.navigate(['/time-periods']);
    }

    navigateToRemoveCustomer() {
        this.router.navigate(['/remove-customer']);
    }

    navigateToDeleteAllCustomers() {
        this.router.navigate(['/delete-all-customers']);
    }
